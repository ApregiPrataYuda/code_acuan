 ...
 <form action="" method="post">
  <div class="row">
    ...
    <label for="kode_masuk"><span class="badge badge-primary"> Kode Asset Masuk</span> </label>
      <input type="text" class="form-control" value="<?=set_value('kode_masuk')?>" name="kode_masuk" id="kode_masuk" placeholder="kode masuk  ...">
    ...
    <label for="tanggal_masuk"><span class="badge badge-primary"> Tanggal Asset Masuk</span> </label>
      <input type="date" class="form-control" value="<?=set_value('tanggal_masuk')?>" name="tanggal_masuk" id="tanggal_masuk">
    ...
    <label for="pengirim"><span class="badge badge-primary"> Pengirim</span> </label>
      <input type="text" class="form-control" value="<?=set_value('pengirim')?>" name="pengirim" id="pengirim" placeholder="Pengirim  ...">
    ...
    <label for="total_qty"><span class="badge badge-primary"> Total Qty</span> </label>
      <input type="number" class="form-control" value="<?=set_value('total_qty')?>" name="total_qty" id="total_qty">
  ...
  <div class="row mt-3">
    ...
    <label for="total_harga"><span class="badge badge-primary"> Total Harga</span> </label>
      <input type="text" class="form-control" value="<?=set_value('total_harga')?>" name="total_harga" id="rupiah" placeholder="Total Harga ...">
