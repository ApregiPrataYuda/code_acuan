...
<div class="card">
  ...
  <a href="<?= site_url('Karyawan/add')?>" class="btn  btn-primary btn-sm "><i class="fa fa-plus"></i> Add Data</a>
  </div>
    ...
    $no=1;
      foreach ($row->result() as $key => $data) { ?>
        <tr>
          ...
          <td><?= $data->name?></td>
          <td>
          <a href="<?=site_url('Karyawan/edit/'. $data->kry_id)?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
        <a href="<?=site_url('Karyawan/delete/'. $data->kry_id)?>" id="btn-hapus" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
          </td>
        </tr>
      <?php } ?>
