 ...
 <form action="" method="post">
  <div class="row">
    ...
    <label for="nik"><span class="badge badge-primary"> Nik Karyawan</span> </label>
      <input type="hidden" value="<?=$row->kry_id?>" name="kry_id">
      <input type="text" class="form-control" value="<?= $this->input->post('nik') ?? $row->nik?>" name="nik" id="nik" placeholder="Nik Karyawan ...">
    ...
    <label for="name"><span class="badge badge-primary"> Nama Karyawan</span> </label>
      <input type="text" class="form-control" value="<?= $this->input->post('name') ?? $row->name?>" name="name" id="name" placeholder="Nama Karyawan ...">
